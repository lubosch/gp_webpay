...
RSpec.describe GpWebpay::Ws::Services::ProcessCancelCapture do
  ...
  let!(:params) { { message_id: '324234=2342342', payment_number: '321422' } }

  context 'when no authentication is required' do
    it 'returns ok' do
      savon.expects(:process_authorization_reverse).with(message: include(authorization_reverse_request: anything))
        .returns('
              <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/">
                <soapenv:Body>
                  <ns4:processAuthorizationReverseResponse xmlns:ns4="http://gpe.cz/pay/payws/proc/v1" xmlns:ns2="http://gpe.cz/pay/pay-ws/core/type" xmlns="http://gpe.cz/gpwebpay/additionalInfo/response" xmlns:ns3="http://gpe.cz/pay/payws/proc/v1/type" xmlns:ns5="http://gpe.cz/gpwebpay/additionalInfo/response/v1">
                    <ns4:authorizationReverseResponse>
                  ...
                  </ns4:processAuthorizationReverseResponse>
                </soapenv:Body>
              </soapenv:Envelope>')
  ...
  context 'http 500' do
    it 'returns false' do
      savon.expects(:process_authorization_reverse).with(message: :any).returns(code: 500, headers: {}, body: '')
  ...
  context 'soap fault' do
    it 'returns false' do
      savon.expects(:process_authorization_reverse).with(message: :any).returns('
              <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/">
                <soapenv:Body>
                  <soapenv:Fault>
