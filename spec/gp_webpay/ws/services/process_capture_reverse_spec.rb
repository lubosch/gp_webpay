...
RSpec.describe GpWebpay::Ws::Services::ProcessCaptureReverse, type: :webservice do
  before { savon.mock! }
  after { savon.unmock! }
      ...
      savon.expects(:process_capture_reverse).with(message: include(capture_reverse_request: anything))
        .returns('
              <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/">
                <soapenv:Body>
                  <ns4:processCaptureReverseResponse xmlns:ns4="http://gpe.cz/pay/pay-ws/proc/v1" xmlns:ns2="http://gpe.cz/pay/pay-ws/core/type" xmlns="http://gpe.cz/gpwebpay/additionalInfo/response" xmlns:ns3="http://gpe.cz/pay/payws/proc/v1/type" xmlns:ns5="http://gpe.cz/gpwebpay/additionalInfo/response/v1">
                    <ns4:captureReverseResponse>
                  ...
                  </ns4:processCaptureReverseResponse>
               </soapenv:Body>
              </soapenv:Envelope>')
  ...
  context 'http 500' do
    it 'returns false' do
      savon.expects(:process_capture_reverse).with(message: :any).returns(
